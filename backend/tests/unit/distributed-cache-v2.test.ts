...
describe('Distributed Cache V2', () => {
  // Use a test-specific cache path
  const testCachePath = path.join(__dirname, '../test-distributed-cache-v2');
  let cacheService: any; // Use any type to bypass TypeScript checks
