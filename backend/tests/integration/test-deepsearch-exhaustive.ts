// filepath: /workspaces/owl-fenc-flowchart/backend/tests/integration/test-deepsearch-exhaustive.ts
...
import { MaterialCalculatorFactory } from '../../src/engines/materials/material-calculator.factory';
...
import { ConstructionMethodCacheService } from '../../src/services/construction-method-cache.service';
import { MaterialCacheService } from '../../src/services/cache.service';
import { FenceDimensions, FenceOptions, FenceType, RequiredMaterial, Location } from '../../src/interfaces/fence.interfaces';
